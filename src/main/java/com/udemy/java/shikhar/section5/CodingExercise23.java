...
public class CodingExercise23 {
    ...
    public static void main(String[] args) {
        //System.out.println(90*0.1);
        //System.out.println("reverse value of 123 is ...... "+reverse(100));
        //System.out.println("1010 reverse " + reverse(1010));//reverse is 0101
        //numberToWords(100);
        //System.out.println("hello "+reverse(123));
        //numberToWords(123);
        //numberToWords(100);
    ...
    public static void numberToWords(int number) {
        ...
        int reverseNumber = reverse(newNumber);
        int newReverseNumber = reverseNumber;
        ...
        int reverseLength = getDigitCount(newReverseNumber);
        int newReverselength=Integer.toString(reverseLength).length();
        if(number%10==0) {
            if (reverseLength < numberLength) {
                for (int i = reverseLength; reverseLength < numberLength; newReverselength++) {
                    reverseLength++;
                    System.out.println("Zero");
                }
            }
