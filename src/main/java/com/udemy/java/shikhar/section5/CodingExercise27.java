...
//        double randomDecimal=12.55;
//        int randomInt=(int)(randomDecimal);
//        System.out.println("Casting converts one primitive datatype to another: "+randomInt);
//        System.out.println("Math.round() rounds the number "+ Math.round(randomDecimal));
    ...
    public static void inputThenPrintSumAndAverage(){
        ...
        while(true) {
            ...
            if (isInt) {
                ...
                int newSum=(int)(sum);
                System.out.println("SUM = " + newSum + " AVG = " + average);
                break;
            }
        }
    }
